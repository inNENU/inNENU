...
declare const getRichTextNodes: (content: string | AnyNode[], options?: GetNodeOptions) => Promise<RichTextNode[]>;

export { type ElementNode, type GetNodeOptions, type RichTextNode, type TextNode, getRichTextNodes, getText };
