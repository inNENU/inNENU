...
export type EmailApplyResponse<T extends EmailApplyOptions> = T extends CheckEmailOptions
  ? CheckEmailResponse
  : ApplyEmailResponse;

const checkEmailOnline = async (options: CheckEmailOptions): Promise<CheckEmailResponse> =>
...
const applyEmailOnline = async (options: ApplyEmailOptions): Promise<ApplyEmailResponse> =>
